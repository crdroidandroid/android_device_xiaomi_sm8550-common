...
public class Constants {
    ...
    // Edge Rejection
    public static final String KEY_EDGE_REJECTION = "edge_rejection_status";
    public static final String NODE_GRIP_REJECTION = "/sys/class/touch/touch_dev/grip_rejection";
